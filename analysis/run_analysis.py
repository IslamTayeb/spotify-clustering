...
Usage:
    python analysis/run_analysis.py                    # Smart cache, interpretable backend
    python analysis/run_analysis.py --backend mert     # Use MERT embeddings
    python analysis/run_analysis.py --fresh            # Force re-extract everything
    python analysis/run_analysis.py --audio-only       # Extract audio only (batch job)
"""
...
Simplified Design:
  ...
  - For interactive exploration: Run streamlit run analysis/interactive_interpretability.py
    ...
    # Create output directories within analysis/
